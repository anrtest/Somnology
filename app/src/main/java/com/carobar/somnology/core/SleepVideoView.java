...
public class SleepVideoView extends VideoView {
    private int mVideoWidth;
    private int mVideoHeight;
    public SleepVideoView(Context context, AttributeSet attrs) {
        super(context, attrs);
    }

    public SleepVideoView(Context context, AttributeSet attrs, int defStyle) {
        super(context, attrs, defStyle);
    }

    public SleepVideoView(Context context) {
        super(context);
    }
